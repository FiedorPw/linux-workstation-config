...
# alias du='dust'      # Rust alternative to 'du' (disk usage)
# alias ps='procs'     # Rust alternative to 'ps' (better process view)
...
alias vim='nvim'
alias hackmuza="coding hacking music connection lost"
alias py='python'
#alias htop="btop"
...
# e/xport PATH=$HOME/bin:/usr/local/bin:$PATH
...
# Override oh-my-zsh ls aliases with eza
